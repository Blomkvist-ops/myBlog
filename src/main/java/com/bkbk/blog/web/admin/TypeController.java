package com.bkbk.blog.web.admin;

import com.bkbk.blog.po.Type;
import com.bkbk.blog.service.TypeService;
...
public class TypeController {
    ...
    public String post(@Valid Type type,BindingResult result, RedirectAttributes attributes) {
        ...
        if (type1 != null) {
            result.rejectValue("name","nameError","Can't add a duplicate type name.");
        }
        if (result.hasErrors()) {
            return "admin/types-input";
        }
    ...
    public String editPost(@Valid Type type, BindingResult result,@PathVariable Long id, RedirectAttributes attributes) {
        Type type1 = typeService.getTypeByName(type.getName());
        if (type1 != null) {
            result.rejectValue("name","nameError","Can't add duplicate types.");
        }
        if (result.hasErrors()) {
            return "admin/types-input";
        }
